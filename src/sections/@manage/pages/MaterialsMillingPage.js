                ...
                {materials.length > 0 ? (
                  <TableBody>
                    {filteredMaterials.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                      const { id, name, purchase_price: purchasePrice, sale_price: salePrice, percentage, stock, active } = row;
...
export default MaterialsMillingPage