...
const SearchMaterialsMillings = ({handleAddMaterialMilling}) => {
    ...
    const getDataAutoComplete = (searchTerm) => {
        ...
        axios.get(`/api/materials-milling/s/${searchTerm}`, { signal })
            .then((res) => {
...
export default SearchMaterialsMillings